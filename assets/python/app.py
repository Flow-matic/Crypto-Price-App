...
col7.metric(col7_selection, col7_price, col7_percent)
col8.metric(col8_selection, col8_price, col8_percent)
col9.metric(col9_selection, col9_price, col9_percent)
